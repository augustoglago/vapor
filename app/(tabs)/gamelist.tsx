    ...
    return (
        ...
        >
            ...
            <View className="flex-1 justify-center items-center p-2">
                <Text className="text-white text-xs text-center font-semibold" numberOfLines={2}>
                    {game.name}
                </Text>
            </View>
    ...
    return (
        <View className="flex-1 bg-vapor-primary">
            ...
            <FlatList
                ...
                numColumns={3}
                columnWrapperStyle={{justifyContent: "flex-start", marginHorizontal: 8, marginVertical: 4}}
                className="pt-2"
                onEndReached={handleLoadMore}
                onEndReachedThreshold={0.5}
                refreshControl={<RefreshControl refreshing={refreshing} onRefresh={() => fetchGamesData(true, true)}
                                                tintColor="#e2e8f0"/>}
