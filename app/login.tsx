...
import {Image, Pressable, View, KeyboardAvoidingView, ScrollView, Platform} from "react-native";
...
export default function Login() {
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            const errorMessage = error.response?.data?.error || 'Erro desconhecido. Tente novamente.';
            alert(errorMessage);
        } finally {
            setIsLoading(false);
        }
                    ...
                    <View className="flex-1 justify-center px-8 py-12">
                        ...
                        >
                            ...
                            <View className="items-center mb-8">
                                <View
                                    className="w-16 h-16 bg-transparent rounded-2xl justify-center items-center overflow-hidden border border-blue-500/20">
                                    <Image
                                ...
                                <Text className="text-base text-slate-400">Entre na sua conta para continuar</Text>
                            </View>
                            ...
                            <View className="grid gap-4">
                                ...
                                <View>
                                    ...
                                    <Pressable className="mt-2 flex-row justify-end items-center"
